<template>
  <div style="margin-top: 10px">
    <h2>{{ cityName }}</h2>
    <div style="width: auto;height: 650px" id="main"></div>

    <!--    <h2>{{cityNm}}</h2>-->
  </div>

</template>
<!--<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=aYNu34AYwt3QTaApv4nNH5tSAxe7NIGe"></script>-->
<script>
